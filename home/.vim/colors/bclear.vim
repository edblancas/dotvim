...
<!-- saved from url=(0066)https://raw.github.com/vim-scripts/bclear/master/colors/bclear.vim -->
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"></head><body><pre style="word-wrap: break-word; white-space: pre-wrap;">" Vim colorscheme
" Name:         bclear
